...
Lähtekoodis mathmode'i avamiseks ja lõpetamiseks on ainuke valik kasutada tähejärjendit \code{mm}. See tähendab ka seda, et nii tekstisisese matemaatika (\LaTeX is dollarid) kui displaymath'i tegemiseks (\LaTeX is kaldkriips ja kandilised sulud) peab kasutama sama alustavat ja lõpetavat sümbolite järjendit. Lähtekoodis näeks seega matemaatika kirjutamine välja selline:
\begin{tcolorbox}
\begin{verbatim}
